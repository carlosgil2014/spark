            ...
            <div class="box-body">
            	<div class="row">
                  	<div class="col-md-4 form-group">
                  		...
                  		<input class="form-control" type="text" value="<?php echo $datosEmpleado["nombre"] ;?>" readonly>
                  	</div>
                  	<div class="col-md-4 form-group">
                  		<label for="">Correo</label>
                  		<input class="form-control" type="text" value="<?php echo $datosEmpleado["empleados_correo"] ;?>">
                  	</div>
                  	<div class="col-md-4 form-group">
                  		<label for="">Contraseña Computadora</label>
                  		<input class="form-control" type="text" value="<?php echo $datosEmpleado["contraseniacomp"] ;?>">
                  	</div>
               	</div>
               	<div class="row">
                  	<div class="col-md-4 form-group">
                  		<label for="">Contraseña Correo</label>
                  		<input class="form-control" type="text" value="<?php echo $datosEmpleado["contraseniacorreo"] ;?>">
                  	</div>
                  	<div class="col-md-4 form-group">
                  		<label for="">Correo</label>
                  		<input class="form-control" type="text" value="<?php echo $datosEmpleado["empleados_correo"] ;?>">
