                    ...
                    <div class="col-md-12">
                      <div class="nav-tabs-custom">  
                        <ul class="nav nav-tabs">
                          ...
                          <li><a data-toggle="tab" href="#expirados">No Actulizada</a></li>
                        </ul>
                        ...
                        <div class="tab-content">
                          <div id="activos" class="tab-pane fade in active">
                              ...
                              <div class="page-header"> 
                               <button type="button" class="btn btn-success btn-flat btn-sm" onclick="agregar();">Agregar</button>
                              </div>                          
                              ...
                              <table id="tblContraseniasActivos" class="table table-bordered table-striped small">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td><?php echo $empleado['empleados_empresa']; ?></td>
                                    <td><?php echo $empleado['correoagencia']; ?></td>
                                    <td><?php echo $empleado['contraseniacomp']; ?></td>
                                    <td><?php echo $empleado['contraseniacorreo']; ?></td>
                                    <td><?php if($empleado['expira']<1) echo "<font color='red'> Expirado </font>"; else echo $empleado['expira'] . " días"; ?></td>
                                    <td class = "text-center">
                                      <a href="#">
                                        <i class="fa fa-edit" onclick="editar('<?php echo $empleado['idsistemasempleado']; ?>','<?php echo $empleado['empleados_id']; ?>','<?php echo $empleado['nombre']; ?>','<?php echo $empleado['correoagencia']; ?>','<?php echo $empleado['contraseniacomp']; ?>','<?php echo $empleado['contraseniacorreo']; ?>','<?php echo $empleado['expiracion']; ?>');">
                                        </i>
                                      </a>
                                    </td>
                                  </tr>
                          ...
                          <div id="expirados" class="tab-pane fade">
                            <table id="tblContraseniasExpiradas" class="table table-bordered table-striped small">
                                <thead>
                                <tr>
                                  <th>Nombre</th>
                                  <th>Tipo</th>
                                ...
                                <tbody>
                                  <?php 
                                  foreach($empleadosExpirados as $empleado){
                                  ?>
                                  <tr>
                                    <td><?php echo $empleado['nombre']; ?></td>
                                    <td><?php echo $empleado['empleados_empresa']; ?></td>
