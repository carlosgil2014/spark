<div class="modal-dialog" role="document">
  <div class="modal-content">
      ...
      <div class="row">
        <div class="form-group col-md-7">
          ...
          <div class="input-group">
            <input type="text" class="form-control input-sm" maxlength="20" id="sim">
            <span class="input-group-btn">
              <button type="button" class="btn btn-sm btn-info btn-flat" onclick="añadirSim();"><i class="fa fa-arrow-circle-right"></i></button>
            </span>
          </div>
    ...
    <div class="modal-footer">
      ...
      <button type="submit" class="btn btn-success btn-sm" onclick="guardar(this);">Guardar</button>
    </div> 
  </div>
</div>
