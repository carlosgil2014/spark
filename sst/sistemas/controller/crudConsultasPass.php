	...
	public function principal(){
		...
		if(isset($_GET["accion"])){
				...
				switch ($_GET["accion"]) {
					...
					case 'index':
						$this->varEmpleados->limpiarEmpleadosBaja();
						$empleados = $this->varEmpleados->listarEmpleadosActivos();
						$empleadosBaja = $this->varEmpleados->listarEmpleadosBajas();
						$empleadosExpirados =$this->varEmpleados->listarEmpleadosExpirados();
