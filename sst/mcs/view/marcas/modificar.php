...
<html>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li>
              <a href="crudMarcas.php?accion=alta">
            ...
            <div class="col-md-4 col-md-offset-4">
              ...
              <div class="box box-warning">
                <div class="box-header with-border">
                  <h3 class="box-title">Marca/Modificar</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                  <div class="box-body">
                    ...
                    <div class="col-md-12">
                      <div class="tab-content">
                        <div id="fisica" class="tab-pane active schedule-pane">
                          <form data-toggle="validator" method="POST" role="form" action="crudMarcas.php?accion=actualizar">
                          <input type="hidden" name="idMarca" value="<?php echo $_GET['idMarca'];?>">
                            ...
                            <div class="form-group col-md-6 col-xs-6">
                              <button type="button" class="btn btn-sm btn-danger pull-right" onclick="eliminar(<?php echo $_GET['idMarca'];?>,'<?php echo $idMarca['marca'];?>');">Eliminar</button>
                            </div>
                          </form>
                        </div>
                      </div>
      ...
      <div class="modal-dialog modal-sm">
        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title">Marcas/Eliminar</h4>
          </div>
          <div class="modal-body text-center">
          ¿Eliminar la Marca <b id="MarcaEliminar"></b>?
          </div>
    ...
    <!-- Alta Bancos -->
    <script src="../js/V1/marcas/modificar.js"></script>
  </body>
</html>
