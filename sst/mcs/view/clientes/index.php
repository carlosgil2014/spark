              ...
              <div class="box box-info">
                ...
                <div class="box-body table-responsive">
                  <table id="tblClientes" class="table table-bordered table-striped">
                    ...
                    ?>
                    <tr>
                      <td><?php echo $clientes["razon_soc"]?></td>
                      <td><?php echo $clientes["rfc"]?></td>
                      <td><?php echo $clientes["nombreComercial"]?></td>
                      <td class = "text-center">
                        <a href="crudClientes.php?accion=modificar&idClient=<?php echo $clientes['idproveedor'];?>">
