            ...
            <div class="col-md-12">
              ...
              <div class="box box-success">
                <div class="box-header with-border">
                  <h3 class="box-title">Proveedores/Agregar</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                  <div class="box-body">
                    ...
                    <div class="col-md-12">
                      <div class="tab-content">
                        ...
                        <div id="fisica" class="tab-pane active schedule-pane">
                          <form data-toggle="validator" role="form" method="POST" action="crudProveedores.php?accion=guardar">
                            ...
                            <div class="form-group col-md-4">
                              ...
                              ?>
                                <option <?php if ($estado["idestado"] == 57) echo "selected";?>><?php echo $estado["nombre"]?></option>
                              <?php
                              }
                              ?>
                              </select>
                            ...
                            <div class="form-group col-md-4">
                              ...
                              ?>
                                <option value="<?php echo $metodoPago['idmetodopago']?>"><?php echo $metodoPago["nombre"]?></option>
                              <?php
                              }
                              ?>
                              </select>
                            ...
                            <div class="form-group col-md-4">
                              ...
                              ?>
                                <option value="<?php echo $banco['idbanco']?>"><?php echo $banco["nombre"]?></option>
                              <?php
                              }
                              ?>
                              </select>
                        ...
                        <div id="moral" class="tab-pane schedule-pane">
                          <form data-toggle="validator" role="form" method="POST" action="crudProveedores.php?accion=guardar">
                            ...
                            <div class="form-group col-md-2">
                              <label class="control-label">&nbsp;</label>
                              <input id="otro_moral" type="number" class="form-control input-sm"  min="0" step="1" max="999" data-error="Es un campo obligatorio (1-999)" value="8" name="Datos[diasCredito]" readonly="true" required>
                              <div class="help-block with-errors">&nbsp;</div>
                            </div>
                            <div class="form-group col-md-4">
                              <label class="control-label">Método de Pago</label>
                        ...
                        <div id="extranjero" class="tab-pane schedule-pane">
                          <form data-toggle="validator" role="form" method="POST" action="crudProveedores.php?accion=guardar">
                            ...
                            <div class="form-group col-md-2">
                              <label class="control-label">&nbsp;</label>
                              <input id="otro_extranjero" type="number" class="form-control input-sm"  min="0" step="1" max="999" data-error="Es un campo obligatorio (1-999)" name="Datos[diasCredito]" value="0" readonly="true">
                              <div class="help-block with-errors">&nbsp;</div>
                            </div>
                            <div class="form-group col-md-4">
                              <label class="control-label">Método de Pago</label>
