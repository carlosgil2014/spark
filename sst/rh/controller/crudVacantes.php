...
//caso para el inicio
		case "index":
			session_start();
			require_once("../model/vacantes.php");
			$varMarca = new marcas();
			$marcas = $varMarca -> listar();
			include_once("../view/vacantes/index.php");
...
//caso para dar de alta una nueva marca de computadora
		case "alta":
			...
			if(isset($_SESSION["spar_error"]) && $_SESSION["spar_error"] === "OK"){
				...
				header("Location: crudVacantes.php?accion=alta");
			}
			else
				$clase = "danger";
			include_once("../view/vacantes/alta.php");
			// unset($_SESSION["spar_error"]);
			break;
...
//caso para actualizacion de la informacion 			
		case "modificar":
			...
			if(isset($_SESSION["spar_error"]) && $_SESSION["spar_error"] === "OK"){
				...
				$clase = "danger";
			include_once("../view/vacantes/modificar.php");
			//unset($_SESSION["spar_error"]);
			break;
...
//caso para actualizar la informacion
		case "actualizar":
			...
			// {
				...
				$_SESSION["spar_error"] = $resultado;
				// echo $_SESSION["spar_error"];
				header("Location: crudVacantes.php?accion=modificar&idComputadoras=");
			break;
