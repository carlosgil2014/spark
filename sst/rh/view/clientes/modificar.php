      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li>
              <a href="crudClientes.php?accion=alta"> 
                    ...
                    <div class="col-md-12">
                      <div class="tab-content">
                        ...
                        <div id="fisica" class="tab-pane <?php if($cliente["tipo"] == 1) echo 'active';?> schedule-pane">
                          <form data-toggle="validator" role="form" method="POST" action="crudClientes.php?accion=actualizar&idCliente=<?php echo $_GET['idCliente'];?>">
                            ...
                            <div class="form-group col-md-4">
                              ...
                              ?>
                                <option <?php if ($estado["nombre"] == $cliente["estado"]) echo "selected";?>><?php echo $cliente["nombre"]?></option>
                              <?php
                              }
                              ?>
                              </select>
