...
<html>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li>
              <a href="crudCategorias.php?accion=alta">
            ...
            <div class="col-md-4 col-md-offset-4">
              ...
              <div class="box box-warning">
                <div class="box-header with-border">
                  <h3 class="box-title">Categorias/Modificar</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                  <div class="box-body">
                    ...
                    <div class="col-md-12">
                      <div class="tab-content">
                        <div id="fisica" class="tab-pane active schedule-pane">
                          <form data-toggle="validator" method="POST" role="form" action="crudCategorias.php?accion=actualizar">
                          <input type="hidden" name="idCategoria" value="<?php echo $_GET['idCategoria'];?>">
                            <div class="form-group col-md-12">
                              <label class="control-label">Categoria</label>
                              <input type="text" name="Categoria" class="form-control input-sm" data-error="Es un campo obligatorio" value="<?php echo $Categoria['categoria'];?>" required>
                            ...
                            <div class="form-group col-md-6 col-xs-6">
                              <button type="button" class="btn btn-sm btn-danger pull-right" onclick="eliminar(<?php echo $_GET['idCategoria'];?>,'<?php echo $Categoria['categoria'];?>');">Eliminar</button>
                            </div>
                          </form>
                        </div>
                      </div>
      ...
      <div class="modal-dialog modal-sm">
        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title">Categorias/Eliminar</h4>
          </div>
          <div class="modal-body text-center">
          ¿Eliminar la Categoria <b id="CategoriaEliminar"></b>?
          </div>
    ...
    <!-- Alta Bancos -->
    <script src="../js/V1/categorias/modificar.js"></script>
  </body>
</html>
