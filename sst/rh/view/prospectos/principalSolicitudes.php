              ...
              <div class="box box-info">
                ...
                <div class="box-body">
                 <!-- <div class="page-header">
                  ...
                  <table id="tblProspectosSolicitudes" class="table table-bordered table-striped small">
                    <thead>
                      <tr>
                        <th>Solicitante</th>
                        <th>Puesto</th>
                    ...
                    ?>
                      <tr>
                        <td><?php echo strtoupper($solicitud['solicitante']);?></td>
                        <td><?php echo $solicitud["nombre"]?></td>
                        <td><?php echo $solicitud["rfc"]?></td>
                        <td><?php echo $solicitud["telefonoCelular"]?></td>
                        <td><?php echo $solicitud["sexo"]?></td>
                        <td class = "text-center">
                          <a style="cursor: pointer;" onclick="listarVacantesDisponibles('<?php echo base64_encode(json_encode($solicitud)); ?>')">
