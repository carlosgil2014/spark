      ...
      <div class="modal-body">
        <div class="row">
          ...
          <div class="form-group col-md-3">
            ...
            <input type="text" class="form-control input-sm" maxlength="25" pattern="^[0-9]{5}" data-error="Es un campo obligatorio" name="Datos[puesto]" required readonly value="REPRESENTANTES REGIONAL">
          </div>
          <div class="form-group col-md-3">
