        ...
        <div class="row">
          ...
          <div class="form-group col-md-3">
            ...
            <div class="input=-group">
              <input type="text" tabindex="9"  id="codigoPostal" maxlength="5" class="form-control" name="Datos[cp]" onchange="cp()" value="<?php echo $representante['cp']; ?>" required>
