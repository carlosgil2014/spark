            ...
            <div class="col-md-4 col-md-offset-4">
              ...
              <div class="box box-warning">
                <div class="box-header with-border">
                  <h3 class="box-title">Marcas/Modificar</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                  <div class="box-body">
                      ...
                      <div class="tab-content">
                        <div id="fisica" class="tab-pane active schedule-pane">
                          ...
                          <input type="hidden" name="idMarca" value="<?php echo $_GET['idMarca'];?>">
                            ...
                            <div class="form-group col-md-6 col-xs-6">
                              <button type="button" class="btn btn-sm btn-danger pull-right" onclick="eliminar(<?php echo $_GET['idMarca'];?>,'<?php echo $Marca['marca'];?>');">Eliminar</button>
                            </div>
                          </form>
                        </div>
                      </div>
