...
<head>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <li>
              <a href="crudVacantes.php?accion=alta">
                <i class="fa fa-arrow-left"></i> <span>Alta-Vacantes</span>
              </a>
            </li>
      <li>
...
<!--**************Termina la parte del panel**********************-->
    ...
    <script>
        ...
        $("#vacante").on('click', function(){
          $("#fisica").clone().removeClass('fila-fija').appendTo("#fisica");
        });
