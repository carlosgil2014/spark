...
echo "<br>";
CalcularRFC("GERARDO","MEDINA","CARDONA","04111968");
echo "<br>";
CalcularRFC("DANIELA","MARTINEZ","URIBE","11011988");
echo "<br>";
CalcularRFC("JORGE","ZARZA","ESCOBEDO","14021969");
echo "<br>";
CalcularRFC("OSCAR","CRUZ","LOPEZ","14021969");
echo "<br>";
