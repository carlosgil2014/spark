          ...
          <ul class="sidebar-menu">
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="view/proveedores/index.php?accion=index"><i class="fa fa-cubes"></i> Representantes</a></li>
                <li><a href="view/usuarios/index.php?accion=index"><i class="fa fa-user"></i> Usuarios</a></li>
                <li><a href="view/regiones/index.php?accion=index"><i class="fa fa-user"></i> Regiones</a></li>
              </ul>
            </li>
