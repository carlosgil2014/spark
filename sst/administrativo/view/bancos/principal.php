            ...
            <div class="col-md-12">
              ...
              <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Bancos/Principal</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body table-responsive">
                  ...
                  <table id="tblBancos" class="table table-bordered table-striped small">
                    <thead>
                    <tr>
                      <th>Banco</th>
                      <th></th>
                    ...
                    <tr>
                      ...
                      <td class = "text-center">
                        <a style="cursor: pointer;" onclick="modificar('<?php echo $banco['idbanco'];?>');">
                          <i class="fa fa-pencil-square-o"></i>
                        </a>
                      </td>
                      <td class = "text-center">
                        <a style="cursor: pointer;" onclick="eliminar('<?php echo $banco['idbanco'];?>','<?php echo $banco['nombre'];?>');">
