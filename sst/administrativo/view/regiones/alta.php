  ...
  <div class="modal-content">
    <form id="formAgregar" method="POST" role="form" action="index.php?accion=guardar">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><b>Agregar Región</b></h4>
      </div>
      <div class="modal-body">
        <div class="row">
          <div class="form-group col-md-12">
            <label class="control-label">Región</label>
            <input type="text" name="region" class="form-control input-sm" data-error="Es un campo obligatorio" required>
