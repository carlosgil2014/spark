...
<html>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="wrapper">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Mensajeria/Principal</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body table-responsive">
                  ...
                  <table id="tblMensajeria" class="table table-bordered table-striped">
                    <thead>
                    <tr>
                      <th>Mensajeria</th>
                      <th>Página de rastreo</th>
                      <th>Editar</th>
                      <th>Eliminar</th>
                    </tr>
                    </thead>
                    ...
                    ?>
                    <tr>
                      <td><?php echo $mensajeria["nombre"]?></td>
                      <td><button class="btn btn-success" onclick="window.open('<?php echo $mensajeria['urlrastreo'];?>','_blank')">Rastrear</button></td>
                      <td class = "text-center">
                        <a style="cursor: pointer;" onclick="modificar('<?php echo $mensajeria['idmensajeria'];?>','<?php echo $mensajeria['nombre'];?>','<?php echo $mensajeria['urlrastreo'];?>');">
                          <i class="fa fa-pencil-square-o"></i>
                        </a>
                      </td>
                      <td class = "text-center">
                        <a style="cursor: pointer;" onclick="eliminar('<?php echo $mensajeria['idmensajeria'];?>','<?php echo $mensajeria['nombre'];?>');">
      ...
      <div class="modal fade" id="modalMensajeria" role="dialog">              
      </div>
      <!-- Modal Eliminar -->
        ...
        <div class="modal-dialog modal-sm">
          ...
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title">Mensajeria/Eliminar</h4>
            </div>
            <div class="modal-body text-center">
            ¿Eliminar la mensajeria <b id="mensajeriaEliminar"></b>?
            </div>
    ...
    <!-- Index Bancos -->
    <script src="../../js/V1/mensajerias/index.js"></script>
  </body>
</html>
