            ...
            <div class="col-md-12">
              ...
              <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Almacén/Principal</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body table-responsive">
                  ...
                  <table id="tblAlmacenes" class="table table-bordered table-striped small">
                    ...
                    <tr>
                      ...
                      <td class = "text-center">
                        <a style="cursor: pointer;" onclick="eliminar('<?php echo $almacen['idAlmacen'];?>');">
        ...
        <div class="modal-dialog modal-sm">
          ...
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title">Almacén/Eliminar</h4>
            </div>
            <div class="modal-body text-center">
            ¿Eliminar el almacén <b id="almacenEliminar"></b>?
            </div>
