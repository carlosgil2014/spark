          ...
          <ul class="sidebar-menu">
            ...
            <li>
              <a href="index.php?accion=alta"> 
                <i class="fa fa-plus"></i> <span>Agregar Modelo</span>
              </a>
            </li>
            <li>
            ...
            <div class="col-md-12">
              ...
              <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Modelos/Principal</h3>
                  ...
                  <table id="tblModelos" class="table table-bordered table-striped">
                    ...
                    <tr>
                      ...
                      <td class = "text-center">
                        <a href="index.php?accion=modificar&idModelo=<?php echo $modelo['idModelo'];?>">
