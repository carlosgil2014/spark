                    ...
                    <div class="col-md-12">
                      <div class="tab-content">
                        ...
                        <div id="fisica" class="tab-pane active schedule-pane">
                          <form data-toggle="validator" role="form" method="POST" id="formularioFisica" action="index.php?accion=guardar">
                            ...
                            <div class="form-group col-md-3">
                              ...
                              <input type="text" class="form-control input-sm" maxlength="60" tabindex="3" data-error="Es un campo obligatorio" name="Datos[apellidoPaterno]" required id="apellidoPaterno">
                              <div class="help-block with-errors">&nbsp;</div>
                            </div>
                            <div class="form-group col-md-3">
                        ...
                        <div id="moral" class="tab-pane schedule-pane">
                          <form data-toggle="validator" role="form"  id="formularioMoral" method="POST" action="index.php?accion=guardar">
                            <div class="form-group col-md-3">
                              <label class="control-label">R.F.C.</label>
  ...
  <div class="modal-dialog modal-sm">
          ...
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <a style="cursor: pointer;" class="btn btn-danger btn-sm" data-dismiss="modal" id="noFisicas">No</a>
            </div>
          </div>
    </div>
</div>
