                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                              ...
                              <select class="form-control input-sm selectpicker" data-error="Es un campo obligatorio" data-live-search="true"  name="idSubcategoria" required>
                                ...
                                ?>                            
                                <option <?php if($productos["idSubcategoria"] == $subCategoria["idSubcategoria"]){echo "selected";}?> value="<?php echo $subCategoria['idSubcategoria']?>"><?php echo $subCategoria['subcategoria']?></option>';
                                <?php
                                }
                                ?>
                              </select>
