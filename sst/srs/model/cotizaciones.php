...
class cotizaciones{
...

		{
			...
			$consulta = "SELECT idcotizacion from tblcotizacionconceptos WHERE idcotconcepto =".$idCotConcepto;
...

		{
			...
			$consulta="SELECT c.clave_cliente, cot.anio, cot.ncotizacion FROM tblcotizacionconceptos cc JOIN tblcotizaciones cot ON cc.idcotizacion=cot.id JOIN tblclientes c ON cot.idcliente=c.idclientes WHERE cc.idcotconcepto=".$idcotconcepto;
