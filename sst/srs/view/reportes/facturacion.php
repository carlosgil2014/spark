...
<html lang="en">
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <br>
                    <br>
                        <h1 class="page-header">Reporte de Facturación</h1>
                </div>
                <form action="crudReportes.php?accion=reporteFacturacion" method="POST">
                    <div class="row">
                            ...
                            <table class="table table-condensed">
                                <tbody>
                                  <?php
                                    ...
                                    ?>
                                        <td class="warning text-center" <?php echo $hidden;?>>
        ...
        <!-- Custom Theme JavaScript -->
        <script src="../js/reportes/facturacion.js"></script>
