    ...
    ?>
      <tr>
        ...
        <td class="text-center">
          ...
          ?>
          <select class="selectpicker text-center" onclick="onfocusEstado(this);" onchange="cambiarEstado('<?php echo $cotizacion['id']?>', 'Cotizaciones', this, '<?php echo $cotizacion['fechaInicial']?>', '<?php echo $cotizacion['fechaFinal']?>','<?php echo $cotizacion['estado']?>');" data-width="50px" style="background-color:transparent" data-container="body">
