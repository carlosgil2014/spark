<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="table-responsive" id="folio">
                <form id="formGuardar">
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-default btn-flat input-sm" data-dismiss="modal">Cerrar</button>
            <button type="button" class="btn btn-success btn-flat input-sm" onclick="guardar('<?php echo base64_encode($datosPrefactura["idprefactura"]);?>','<?php echo base64_encode($datos[0]["id_rubro"]);?>',this);">Guardar</button>
        </div>
    </div>
</div>