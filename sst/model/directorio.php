...
//funcion para actualizar los registros
    ...
    public function bajaDirectorio(){
   			$datos = array();
   			$borrar="DELETE d tblDirectorio FROM tblDirectorio d LEFT JOIN spar_empleados s ON d.idUsuario=s.empleados_id where 90>=DATEDIFF(CURDATE(),s.empleados_fecha_baja)";
